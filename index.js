...
(function($PS) {
  ...
  var exports = $PS["Color.Scheme.Clrs"];
  var Color = $PS["Color"];            
...
(function($PS) {
  ...
  exports["fromTranslate"] = fromTranslate;
...
(function($PS) {
      ...
      return function (canvasImageSources) {
          return function (v) {
              ...
              if (v instanceof Pattern) {
                  ...
                  throw new Error("Failed pattern match at Graphics.Glapple.Data.Picture (line 147, column 38 - line 152, column 40): " + [ v1.constructor.name ]);
              };
              ...
              throw new Error("Failed pattern match at Graphics.Glapple.Data.Picture (line 136, column 39 - line 155, column 43): " + [ v.constructor.name ]);
          };
      };
  };
  ...
  var runShape = function (ctx) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Graphics.Glapple.Data.Picture (line 114, column 16 - line 120, column 18): " + [ v.constructor.name ]);
      };
  };
              ...
              return function (v) {
                  return saveAndRestore(Effect_Class.monadEffectEffect)(ctx)(Effect_Class.liftEffect(Effect_Class.monadEffectEffect)(function __do() {
                      (function () {
                          ...
                          if (v1 instanceof Data_Maybe.Just) {
                              Graphics_Canvas.moveTo(ctx)(v1.value0.head.real)(v1.value0.head.image)();
                              Control_Safely.for_(Data_Foldable.foldableArray)(Control_Monad_Rec_Class.monadRecEffect)(v1.value0.tail)(function (v2) {
                                  return Graphics_Canvas.lineTo(ctx)(v2.real)(v2.image);
                              })();
                          ...
                          throw new Error("Failed pattern match at Graphics.Glapple.Data.Picture (line 383, column 3 - line 388, column 25): " + [ v1.constructor.name ]);
                      })();
                      return runShape(ctx)(style)();
                  }));
              };
  ...
  var paint = function (drawStyle) {
      return function (shape) {
          return function (ctx) {
              return function (img) {
                  return saveAndRestore(Effect_Class.monadEffectEffect)(ctx)(function __do() {
                      Effect_Class.liftEffect(Effect_Class.monadEffectEffect)(setDrawStyle(ctx)(img)(drawStyle))();
  ...
  var fan = function (style) {
      return function (v) {
          return function (ctx) {
              return function (v1) {
                  return saveAndRestore(Effect_Class.monadEffectEffect)(ctx)(Effect_Class.liftEffect(Effect_Class.monadEffectEffect)((function () {
              ...
              return function (ctx) {
                  return function (canvasImageSources) {
                      return function __do() {
                          ...
                          Effect_Class.liftEffect(Effect_Class.monadEffectEffect)(Graphics_Canvas.setGlobalCompositeOperation(ctx)(comp))();
...
(function($PS) {
  ...
  var wireFrame = function (v) {
      if (v instanceof ColliderAppend) {
          return Data_Semigroup.append(Graphics_Glapple_Data_Picture.semigroupPicture)(wireFrame(v.value0))(wireFrame(v.value1));
      };
      if (v instanceof ColliderRect) {
          return Graphics_Glapple_Data_Picture.rect(Graphics_Glapple_Data_Picture.Stroke.value)(v.value0);
      };
      if (v instanceof ColliderCircle) {
          return Graphics_Glapple_Data_Picture.arc({
              angle: 2.0 * $$Math.pi,
              radius: v.value0,
              start: 0.0
          });
      ...
      if (v instanceof ColliderTransform) {
          return Graphics_Glapple_Data_Picture.transform(v.value0)(wireFrame(v.value1));
      };
      if (v instanceof ColliderEmpty) {
          return Data_Monoid.mempty(Graphics_Glapple_Data_Picture.monoidPicture);
      };
      throw new Error("Failed pattern match at Graphics.Glapple.Data.Collider (line 139, column 13 - line 144, column 26): " + [ v.constructor.name ]);
  };
  ...
  var filled = function (v) {
      if (v instanceof ColliderAppend) {
          return Data_Semigroup.append(Graphics_Glapple_Data_Picture.semigroupPicture)(filled(v.value0))(filled(v.value1));
      };
      if (v instanceof ColliderRect) {
          return Graphics_Glapple_Data_Picture.rect(Graphics_Glapple_Data_Picture.Fill.value)(v.value0);
      };
      if (v instanceof ColliderCircle) {
          return Graphics_Glapple_Data_Picture.fan(Graphics_Glapple_Data_Picture.Fill.value)({
              angle: 2.0 * $$Math.pi,
              radius: v.value0,
              start: 0.0
          });
      ...
      if (v instanceof ColliderTransform) {
          return Graphics_Glapple_Data_Picture.transform(v.value0)(filled(v.value1));
      };
      if (v instanceof ColliderEmpty) {
          return Data_Monoid.mempty(Graphics_Glapple_Data_Picture.monoidPicture);
      };
      throw new Error("Failed pattern match at Graphics.Glapple.Data.Collider (line 147, column 10 - line 152, column 26): " + [ v.constructor.name ]);
  };
  var collide = function (c0) {
      return function (c1) {
          if (c0 instanceof ColliderAppend) {
              return Data_Foldable.or(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(Data_Functor.map(Data_Functor.functorArray)(function (c) {
                  return collide(c)(c1);
              })([ c0.value0, c0.value1 ]));
          };
          if (c0 instanceof ColliderRect) {
              if (c1 instanceof ColliderAppend) {
                  return Data_Foldable.or(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(Data_Functor.map(Data_Functor.functorArray)(collide(c0))([ c1.value0, c1.value1 ]));
              };
              if (c1 instanceof ColliderRect) {
                  return true;
              };
              if (c1 instanceof ColliderCircle) {
                  return true;
              };
              if (c1 instanceof ColliderTransform && c1.value1 instanceof ColliderAppend) {
                  return Data_Foldable.or(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(Data_Functor.map(Data_Functor.functorArray)((function () {
                      var $83 = collide(c0);
                      var $84 = ColliderTransform.create(c1.value0);
                      return function ($85) {
                          return $83($84($85));
                      };
                  })())([ c1.value1.value0, c1.value1.value1 ]));
              };
              if (c1 instanceof ColliderTransform && c1.value1 instanceof ColliderRect) {
                  var f = function (cmp) {
                      return function (trs) {
                          return function (cmp$prime) {
                              var vs = Data_Functor.map(Data_Functor.functorArray)(Graphics_Glapple_Data_Transform.transform(trs))([ Data_Semiring.zero(Graphics_Glapple_Data_Complex.semiringComplex), Graphics_Glapple_Data_Complex.complex(Graphics_Glapple_Data_Complex.real(cmp$prime))(0.0), Graphics_Glapple_Data_Complex.complex(0.0)(Graphics_Glapple_Data_Complex.image(cmp$prime)), cmp$prime ]);
                              var sy = new Data_Tuple.Tuple(Data_Maybe.fromMaybe(Data_Number.infinity)(Data_Foldable.minimum(Data_Ord.ordNumber)(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(Graphics_Glapple_Data_Complex.image)(vs))), Data_Maybe.fromMaybe(-Data_Number.infinity)(Data_Foldable.maximum(Data_Ord.ordNumber)(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(Graphics_Glapple_Data_Complex.image)(vs))));
                              var sx = new Data_Tuple.Tuple(Data_Maybe.fromMaybe(Data_Number.infinity)(Data_Foldable.minimum(Data_Ord.ordNumber)(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(Graphics_Glapple_Data_Complex.real)(vs))), Data_Maybe.fromMaybe(-Data_Number.infinity)(Data_Foldable.maximum(Data_Ord.ordNumber)(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(Graphics_Glapple_Data_Complex.real)(vs))));
                              var dy = Data_Tuple.fst(sy) <= Graphics_Glapple_Data_Complex.image(cmp) && 0.0 <= Data_Tuple.snd(sy);
                              var dx = Data_Tuple.fst(sx) <= Graphics_Glapple_Data_Complex.real(cmp) && 0.0 <= Data_Tuple.snd(sx);
                              return dx && dy;
                          };
                      };
                  };
                  return f(c0.value0)(c1.value0)(c1.value1.value0) && f(c1.value1.value0)(Graphics_Glapple_Data_Transform.inverseTransform(c1.value0))(c0.value0);
              };
              if (c1 instanceof ColliderTransform && c1.value1 instanceof ColliderCircle) {
                  var t = Graphics_Glapple_Data_Transform.translate(c1.value0);
                  return -c1.value1.value0 <= Graphics_Glapple_Data_Complex.real(t) && (Graphics_Glapple_Data_Complex.real(t) <= Graphics_Glapple_Data_Complex.real(c0.value0) + c1.value1.value0 && (0.0 <= Graphics_Glapple_Data_Complex.image(t) && Graphics_Glapple_Data_Complex.image(t) <= Graphics_Glapple_Data_Complex.image(c0.value0))) || (0.0 <= Graphics_Glapple_Data_Complex.real(t) && (Graphics_Glapple_Data_Complex.real(t) <= Graphics_Glapple_Data_Complex.real(c0.value0) && (-c1.value1.value0 <= Graphics_Glapple_Data_Complex.image(t) && Graphics_Glapple_Data_Complex.image(t) <= Graphics_Glapple_Data_Complex.image(c0.value0) + c1.value1.value0)) || Data_Array.any(function (cmp) {
                      return isCollidePosition(cmp)(c1);
                  })([ Data_Semiring.zero(Graphics_Glapple_Data_Complex.semiringComplex), Graphics_Glapple_Data_Complex.complex(Graphics_Glapple_Data_Complex.real(c0.value0))(0.0), Graphics_Glapple_Data_Complex.complex(0.0)(Graphics_Glapple_Data_Complex.image(c0.value0)), c0.value0 ]));
              };
              if (c1 instanceof ColliderTransform && c1.value1 instanceof ColliderTransform) {
                  return collide(c0)(new ColliderTransform(Graphics_Glapple_Data_Transform.computeChildTransform(c1.value0)(c1.value1.value0), c1.value1.value1));
              };
              if (c1 instanceof ColliderTransform && c1.value1 instanceof ColliderEmpty) {
                  return false;
              };
              if (c1 instanceof ColliderEmpty) {
                  return false;
              };
              throw new Error("Failed pattern match at Graphics.Glapple.Data.Collider (line 48, column 24 - line 92, column 27): " + [ c1.constructor.name ]);
          };
          if (c0 instanceof ColliderCircle) {
              if (c1 instanceof ColliderAppend) {
                  return Data_Foldable.or(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(Data_Functor.map(Data_Functor.functorArray)(collide(c0))([ c1.value0, c1.value1 ]));
              };
              if (c1 instanceof ColliderRect) {
              ...
              if (c1 instanceof ColliderTransform && c1.value1 instanceof ColliderAppend) {
                  return Data_Foldable.or(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(Data_Functor.map(Data_Functor.functorArray)((function () {
                      var $86 = collide(c0);
                      var $87 = ColliderTransform.create(c1.value0);
                      return function ($88) {
                          return $86($87($88));
                      };
                  })())([ c1.value1.value0, c1.value1.value1 ]));
              ...
              if (c1 instanceof ColliderTransform && c1.value1 instanceof ColliderRect) {
                  var t = Graphics_Glapple_Data_Transform.translate(Graphics_Glapple_Data_Transform.inverseTransform(c1.value0));
                  return -c0.value0 <= Graphics_Glapple_Data_Complex.real(t) && (Graphics_Glapple_Data_Complex.real(t) <= Graphics_Glapple_Data_Complex.real(c1.value1.value0) + c0.value0 && (0.0 <= Graphics_Glapple_Data_Complex.image(t) && Graphics_Glapple_Data_Complex.image(t) <= Graphics_Glapple_Data_Complex.image(c1.value1.value0))) || (0.0 <= Graphics_Glapple_Data_Complex.real(t) && (Graphics_Glapple_Data_Complex.real(t) <= Graphics_Glapple_Data_Complex.real(c1.value1.value0) && (-c0.value0 <= Graphics_Glapple_Data_Complex.image(t) && Graphics_Glapple_Data_Complex.image(t) <= Graphics_Glapple_Data_Complex.image(c1.value1.value0) + c0.value0)) || Data_Array.any(function (cmp) {
                      return isCollidePosition(cmp)(c0);
                  })(Data_Functor.map(Data_Functor.functorArray)(Graphics_Glapple_Data_Transform.transform(c1.value0))([ Data_Semiring.zero(Graphics_Glapple_Data_Complex.semiringComplex), Graphics_Glapple_Data_Complex.complex(Graphics_Glapple_Data_Complex.real(c1.value1.value0))(0.0), Graphics_Glapple_Data_Complex.complex(0.0)(Graphics_Glapple_Data_Complex.image(c1.value1.value0)), c1.value1.value0 ])));
              };
              if (c1 instanceof ColliderTransform && c1.value1 instanceof ColliderCircle) {
                  var t = Graphics_Glapple_Data_Transform.translate(c1.value0);
                  return Graphics_Glapple_Data_Complex.magnitudeSqr(t) <= $$Math.pow(c0.value0 + c1.value1.value0)(2.0);
              };
              if (c1 instanceof ColliderTransform && c1.value1 instanceof ColliderTransform) {
                  return collide(c0)(new ColliderTransform(Graphics_Glapple_Data_Transform.computeChildTransform(c1.value0)(c1.value1.value0), c1.value1.value1));
              };
              ...
              throw new Error("Failed pattern match at Graphics.Glapple.Data.Collider (line 93, column 23 - line 127, column 27): " + [ c1.constructor.name ]);
          };
          if (c0 instanceof ColliderTransform) {
              return collide(c0.value1)(new ColliderTransform(Graphics_Glapple_Data_Transform.inverseTransform(c0.value0), c1));
          };
          if (c0 instanceof ColliderEmpty) {
              return false;
          };
          throw new Error("Failed pattern match at Graphics.Glapple.Data.Collider (line 46, column 17 - line 130, column 25): " + [ c0.constructor.name ]);
      };
  };
  exports["ColliderRect"] = ColliderRect;
...
(function($PS) {
  ...
  var useTransform = Control_Bind.bind(Graphics_Glapple_Data_Hooks.bindHooks)(Control_Monad_Reader_Class.ask(Graphics_Glapple_Data_Hooks.monadAskInternalHooks))(function (v) {
      return Control_Applicative.pure(Graphics_Glapple_Data_Hooks.applicativeHooks)(Effect_Ref.read(v.componentTransform));
  });
...
(function($PS) {
  ...
  var useRunnerNow = function (component) {
      return function (props) {
          return Control_Bind.bind(Graphics_Glapple_Data_Hooks.bindHooks)(useRunner(component))(function (v) {
  ...
  exports["useRunnerNow"] = useRunnerNow;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.7
  "use strict";
...
(function($PS) {
  // Generated by purs version 0.14.7
  "use strict";
  $PS["Graphics.Glapple.UseMouseState"] = $PS["Graphics.Glapple.UseMouseState"] || {};
  var exports = $PS["Graphics.Glapple.UseMouseState"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_Reader_Class = $PS["Control.Monad.Reader.Class"];
  var Effect_Ref = $PS["Effect.Ref"];
  var Graphics_Glapple_Data_Hooks = $PS["Graphics.Glapple.Data.Hooks"];                
  var useMouseState = Control_Bind.bind(Graphics_Glapple_Data_Hooks.bindHooks)(Control_Monad_Reader_Class.ask(Graphics_Glapple_Data_Hooks.monadAskInternalHooks))(function (v) {
      var getMouseState = Effect_Ref.read(v.mouseStateRef);
      return Control_Applicative.pure(Graphics_Glapple_Data_Hooks.applicativeHooks)(getMouseState);
  });
...
(function($PS) {
  // Generated by purs version 0.14.7
  "use strict";
  $PS["Components.ColliderTest"] = $PS["Components.ColliderTest"] || {};
  var exports = $PS["Components.ColliderTest"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Array = $PS["Data.Array"];
  var Data_Unit = $PS["Data.Unit"];
  ...
  var Graphics_Glapple_UseMouseState = $PS["Graphics.Glapple.UseMouseState"];                
  var testCollider = new Graphics_Glapple_Data_Collider.ColliderRect(Graphics_Glapple_Data_Complex.complex(80.0)(160.0));
  var testColliderComponent = function (v) {
      return Control_Bind.bind(Graphics_Glapple_Data_Hooks.bindHooks)(Graphics_Glapple_Hooks_UseTransform.useTransform)(function (getTransform) {
          return Control_Bind.bind(Graphics_Glapple_Data_Hooks.bindHooks)(Graphics_Glapple_Hooks_UseTransform.useTranslate)(function (v1) {
              return Control_Bind.bind(Graphics_Glapple_Data_Hooks.bindHooks)(Graphics_Glapple_Hooks_UseTransform.useRotate)(function (v2) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Graphics_Glapple_Data_Hooks.bindHooks)(Effect_Class.liftEffect(Graphics_Glapple_Data_Hooks.monadEffectHooks)(v1.value1(Graphics_Glapple_Data_Complex.complex(250.0)(250.0))))(function () {
                      return Control_Bind.bind(Graphics_Glapple_Data_Hooks.bindHooks)(Graphics_Glapple_Hooks_UseLocalTime.useLocalTime)(function (getTime) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Graphics_Glapple_Data_Hooks.bindHooks)(Graphics_Glapple_Hooks_UseRenderer.useRenderer(0.0)(function __do() {
                              var time = getTime();
                              v2.value1(time)();
                              return Graphics_Glapple_Data_Collider.wireFrame(testCollider);
                          }))(function () {
                              return Control_Applicative.pure(Graphics_Glapple_Data_Hooks.applicativeHooks)(getTransform);
                          });
                      });
                  });
              });
  ...
  var mouseCollider = new Graphics_Glapple_Data_Collider.ColliderTransform(Graphics_Glapple_Data_Transform.fromTranslate(Graphics_Glapple_Data_Complex.complex(-25.0)(-100.0)), new Graphics_Glapple_Data_Collider.ColliderRect(Graphics_Glapple_Data_Complex.complex(50.0)(200.0)));
  var mouse = function (v) {
      return Control_Bind.bind(Graphics_Glapple_Data_Hooks.bindHooks)(Graphics_Glapple_Hooks_UseTransform.useTranslate)(function (v1) {
          return Control_Bind.bind(Graphics_Glapple_Data_Hooks.bindHooks)(Graphics_Glapple_Hooks_UseTransform.useRotate)(function (v2) {
              return Control_Bind.bind(Graphics_Glapple_Data_Hooks.bindHooks)(Graphics_Glapple_Hooks_UseLocalTime.useLocalTime)(function (getTime) {
                  return Control_Bind.bind(Graphics_Glapple_Data_Hooks.bindHooks)(Graphics_Glapple_UseMouseState.useMouseState)(function (getMs) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Graphics_Glapple_Data_Hooks.bindHooks)(Graphics_Glapple_Hooks_UseUpdate.useUpdate(function (v3) {
                          return function __do() {
                              var ms = getMs();
                              v1.value1(ms)();
                              var time = getTime();
                              Data_Unit.unit;
                              return v2.value1(time * 1.7)();
                          };
                      }))(function () {
                          return Graphics_Glapple_Hooks_UseRenderer.useRenderer(0.0)(function __do() {
                              var tr = v1.value0();
                              var rot = v2.value0();
                              var colliders = v.getColliders();
                              var $17 = Data_Array.any(function (col) {
                                  return Graphics_Glapple_Data_Collider.collide(col)(new Graphics_Glapple_Data_Collider.ColliderTransform(Graphics_Glapple_Data_Transform.fromTranslate(tr), new Graphics_Glapple_Data_Collider.ColliderTransform(Graphics_Glapple_Data_Transform.fromRotate(rot), mouseCollider)));
                              })(colliders);
                              if ($17) {
                                  return Graphics_Glapple_Data_Collider.filled(mouseCollider);
                              };
                              return Graphics_Glapple_Data_Collider.wireFrame(mouseCollider);
                          });
                      });
                  });
              });
  ...
  var colliderTest = function (v) {
      return Control_Bind.bind(Graphics_Glapple_Data_Hooks.bindHooks)(Graphics_Glapple_Hooks_UseRunner.useChildRunnerNow(testColliderComponent)({}))(function (getTestTransform) {
          return Graphics_Glapple_Hooks_UseRunner.useChildRunnerNow(mouse)({
              getColliders: function __do() {
                  var tr = getTestTransform();
                  return [ new Graphics_Glapple_Data_Collider.ColliderTransform(tr, testCollider) ];
              }
          });
      });
  };
  exports["colliderTest"] = colliderTest;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.7
  "use strict";
...
(function($PS) {
  ...
  var Graphics_Glapple_Hooks_UseState = $PS["Graphics.Glapple.Hooks.UseState"];
  var Graphics_Glapple_Hooks_UseUpdate = $PS["Graphics.Glapple.Hooks.UseUpdate"];
  var polygonTest2 = Graphics_Glapple_Data_Picture.translate(Graphics_Glapple_Data_Complex.complex(100.0)(100.0))(Graphics_Glapple_Data_Picture.paint(new Graphics_Glapple_Data_Picture.LinearGradient({
      x0: 0.0,
      y0: 0.0,
      x1: 120.0,
      y1: 120.0,
      colorStops: [ new Data_Tuple.Tuple(0.0, Color_Scheme_Clrs.purple), new Data_Tuple.Tuple(1.0, Color_Scheme_Clrs.red) ]
  ...
  var polygonTest = Graphics_Glapple_Data_Picture.paint(new Graphics_Glapple_Data_Picture.Pattern({
